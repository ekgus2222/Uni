...
static const _Time_Request_type_support_symbol_names_t _Time_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_msgs, srv, Time_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, time_msgs, srv, Time_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, time_msgs, srv, Time_Request)() {
  return &::time_msgs::srv::rosidl_typesupport_c::Time_Request_message_type_support_handle;
}
...
static const _Time_Response_type_support_symbol_names_t _Time_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_msgs, srv, Time_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, time_msgs, srv, Time_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_time_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, time_msgs, srv, Time_Response)() {
  return &::time_msgs::srv::rosidl_typesupport_c::Time_Response_message_type_support_handle;
}
...
static const _Time_type_support_symbol_names_t _Time_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, time_msgs, srv, Time)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, time_msgs, srv, Time)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, time_msgs, srv, Time)() {
  return &::time_msgs::srv::rosidl_typesupport_c::Time_service_type_support_handle;
}
