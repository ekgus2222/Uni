...
static const _Alarm_Request_type_support_symbol_names_t _Alarm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_alarm_interface, srv, Alarm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_alarm_interface, srv, Alarm_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, srv_alarm_interface, srv, Alarm_Request)() {
  return &::srv_alarm_interface::srv::rosidl_typesupport_c::Alarm_Request_message_type_support_handle;
}
...
static const _Alarm_Response_type_support_symbol_names_t _Alarm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_alarm_interface, srv, Alarm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_alarm_interface, srv, Alarm_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_srv_alarm_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, srv_alarm_interface, srv, Alarm_Response)() {
  return &::srv_alarm_interface::srv::rosidl_typesupport_c::Alarm_Response_message_type_support_handle;
}
...
static const _Alarm_type_support_symbol_names_t _Alarm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_alarm_interface, srv, Alarm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_alarm_interface, srv, Alarm)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, srv_alarm_interface, srv, Alarm)() {
  return &::srv_alarm_interface::srv::rosidl_typesupport_c::Alarm_service_type_support_handle;
}
